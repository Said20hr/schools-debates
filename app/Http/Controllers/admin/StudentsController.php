...
class StudentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            $user = User::create([
                ...
                'role' => 'student',
                'status' => true,
                'id_carte' => $this->uploadImagesArray($request->id_carte, 'users/student/id_carte/')
            ]);
        $user->assignRole('student');

        return redirect()->route('students.index')->with('success_message', 'تمت اضافة المتناظر بنجاح');
    ...
    public function update(Request $request, $id)
    {
        ...
        $user->save();
        $request->session()->flash('success_message', 'لقد تم تغيير بيانات المتناظر بنجاح');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('students.index')->with('error_message','تم حذف المتناظر بنجاح');
    }
