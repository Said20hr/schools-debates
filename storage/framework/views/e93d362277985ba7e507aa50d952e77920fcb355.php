                ...
                <div class="col-lg-6 col-md-12 col-sm-12 p-t-36 order-md-2 order-lg-1">
                    ...
                    <div class="p-t-14 p-tb-10-sm row d-sm-flex">
                        <div class="col-md-5 col-sm-2 p-tb-5-sm">
                            <button class="btn btn-primary p-lr-25 p-tb-10 fs-20 font-weight-bold p-tb-5-sm">
                                اطلع
                            </button>
                        </div>
                        <div class="col-md-5 col-sm-2 p-tb-5-sm">
                            <button class="btn btn-outline-primary p-lr-25 p-tb-10 fs-20 font-weight-bold p-tb-5-sm" >
                                سجل في التفاعليات
                            </button>
                        </div>
                ...
                <div class="row text-right">
                    <div class="col-lg-4 col-md-4 col-sm-12 p-tb-14">
                        <div class="trips d-flex justify-content-between align-items-start p-tb-14 p-lr-28">
                            ...
                            <div class="m-t-14 p-lr-10">
                                <h4 class="fw-bold">150 متناظر</h4>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 p-tb-14">
                        <div class="trips d-flex justify-content-between align-items-start p-tb-14 p-lr-28">
                            ...
                            <div class="m-t-14 p-lr-10">
                                <h4 class="fw-bold"> 50 تفاعلية</h4>
                                <p class="fs-17">لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج أليايت</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container p-t-20 p-b-20 text-right">
                ...
                <div class="row align-items-center p-t-50">
                    <div class="col-lg-3 col-sm-12 m-b-50">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <div class="bg-primary p-t-25 avatar">
                                    <img class="img-fluid avatar" src="<?php echo e(asset('images/Placeholder/avatar1.svg')); ?>" alt="">
                                </div>
                                <div class="text-right p-b-30 team-info clblack">
                                    <div class="p-lr-25">
                                    <h5 class="font-weight-bold p-t-20"> اسم المتناظر و لقبه</h5>
                                    <h5 class="p-b-5"> المشاركات في البطوﻻت (5)</h5>
                                    <div class="d-flex">
                                    ...
                                    <div class="p-b-20 text-center">
                                        <a class="btn btn-outline-primary fw-bold col-md-10 fs-18 p-lr-20"> استعراض </a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-12 m-b-50">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <div class="bg-primary p-t-25 avatar">
                                    <img class="img-fluid avatar" src="<?php echo e(asset('images/Placeholder/avatar2.svg')); ?>" alt="">
                                </div>
                                <div class="text-right p-b-30 team-info clblack">
                                    <div class="p-lr-25">
                                        <h5 class="font-weight-bold p-t-20"> اسم المتناظر و لقبه</h5>
                    ...
                    <div class="col-lg-3 col-sm-12 m-b-50">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <div class="bg-primary p-t-25 avatar">
                                    <img class="img-fluid avatar" src="<?php echo e(asset('images/Placeholder/avatar3.svg')); ?>" alt="">
                                </div>
                                <div class="text-right p-b-30 team-info clblack">
                                    <div class="p-lr-25">
                                        <h5 class="font-weight-bold p-t-20"> اسم المتناظر و لقبه</h5>
                    ...
                    <div class="col-lg-3 col-sm-12 m-b-50">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="bg-primary p-t-25 avatar">
                                    <img class="img-fluid avatar" src="<?php echo e(asset('images/Placeholder/avatar4.svg')); ?>" alt="">
                                </div>
                                <div class="text-right p-b-30 team-info clblack">
                                    <div class="p-lr-25">
                                        <h5 class="font-weight-bold p-t-20"> اسم المتناظر و لقبه</h5>
                ...
                <div class="m-tb-14 text-center">
                    <div class="p-tb-14 text-center">
                        <button class="btn btn-primary p-tb-8 fs-22 fw-bold col-md-2 p-tb-15">عرض المزيد</button>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center p-t-50">
                    <div class="col-lg-4 col-sm-12 m-b-50">
                        <div class="card" style="  box-shadow: 0 5px 10px rgba(0,0,0,0.19), 0 2px 2px rgba(0,0,0,0.23);">
                            <div class="card-body text-center">
                                <div class="">
                                    <img class="img-fluid avatar" src="<?php echo e(asset('images/Placeholder/b-3.jpg')); ?>" alt="">
                                </div>
                                <div class="clblack">
                                    <div class="text-right p-t-14 p-lr-14">
                                        <a href="" class="fs-19 font-weight-bolder clblack text-decoration-none">لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج </a>
                                        ...
                                        <div class="p-t-10 text-center">
                                            <a class="btn btn-primary p-tb-10 col-md-8">
                                                طالع
                                            </a>
                                        </div>
                    ...
                    <div class="col-lg-4 col-sm-12 m-b-50">
                        <div class="card" style="  box-shadow: 0 5px 10px rgba(0,0,0,0.19), 0 2px 2px rgba(0,0,0,0.23);">
                            <div class="card-body text-center">
                                <div class="">
                                    <img class="img-fluid avatar" src="<?php echo e(asset('images/Placeholder/co-4.jpg')); ?>" alt="">
                                </div>
                                <div class="clblack">
                                    <div class="text-right p-t-14 p-lr-14">
                                        <a href="" class="fs-19 font-weight-bolder clblack text-decoration-none">لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج </a>
                    ...
                    <div class="col-lg-4 col-sm-12 m-b-50">
                        <div class="card" style="  box-shadow: 0 5px 10px rgba(0,0,0,0.19), 0 2px 2px rgba(0,0,0,0.23);">
                            <div class="card-body text-center">
                                <div class="">
                                    <img class="img-fluid avatar" src="<?php echo e(asset('images/Placeholder/co-2.jpg')); ?>" alt="">
                                </div>
                                <div class="clblack">
                                    <div class="text-right p-t-14 p-lr-14">
                                        <a href="" class="fs-19 font-weight-bolder clblack text-decoration-none">لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج </a>
                            ...
                            <div class="col-lg-9 col-md-2 col-sm-12">
                                <div class="text-center">
                                    ...
                                    <form class="d-flex mt-4">
                                        ...
                                        <input type="email" class="form-control col-md-6 p-lr-28" placeholder="بريدك الالكترونى" required="required" style="border-radius: 0 25px 25px 0">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saidhr20/dev/debates/schools-debates/resources/views/home.blade.php ENDPATH**/ ?>