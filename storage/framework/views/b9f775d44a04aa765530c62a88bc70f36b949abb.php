            ...
            <div class="container text-right">
                <div class="row p-tb-25 p-tb-5-sm d-flex align-items-end">
                    <div class="col-lg-8 col-md-4 col-sm-12 p-t-36 order-md-2 order-lg-1">
                        <h1 class="fs-28 font-weight-bolder color-1"><?php echo e($content->title_3); ?></h1>
                        <div class="separator text-center m-tb-14"></div>
                        <p class="fs-19">
                            <?php echo e($content->text_3); ?>
                ...
                <div class="row p-tb-25 p-b-14 p-tb-5-sm d-flex align-items-end">
                    <div class="col-lg-12 col-md-12 col-sm-12 p-t-36 order-md-2 order-lg-1">
                        <h1 class="fs-28 font-weight-bolder color-1"><?php echo e($content->title_4); ?></h1>
                        <div class="separator text-center m-tb-14"></div>
                        <p class="fs-19">
                            <?php echo e($content->text_4); ?>
                ...
                <div class="row p-tb-25   p-tb-5-sm d-flex align-items-end">
                    <div class="col-lg-8 col-md-4 col-sm-12 p-t-36 order-md-2 order-lg-1">
                        <h1 class="fs-28 font-weight-bolder color-1"><?php echo e($content->title_5); ?></h1>
                        <div class="separator text-center m-tb-14"></div>
                        <p class="fs-19">
                            <?php echo e($content->text_5); ?>
