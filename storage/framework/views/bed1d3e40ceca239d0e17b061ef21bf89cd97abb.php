        ...
        <section class="p-tb-120">
            <div class="container p-t-20 p-b-20 text-right">
                <div class="text-center mb-5">
                    <h1 class="color-2 fs-42 fw-bold ">المدربين</h1>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saidhr20/dev/debates/schools-debates/resources/views/pages/coaches.blade.php ENDPATH**/ ?>