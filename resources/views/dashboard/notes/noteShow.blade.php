                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input id="name" class="form-control " type="text"
                                                               name="name" value="{{ $note->user_id }}" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input id="lastname" class="form-control" type="text"
                                                               name="lastname" value="{{ $note->type }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input id="job" class="form-control " type="text"
                                                             name="job" value="{{ $note->title}}" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <textarea name="content" id="content" cols="30" rows="10"
                                                                  class="form-control p-tb-20 p-lr-20" disabled>{{$note->content}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('notes.index') }}" class="btn col-md-2 btn-lg fs-20 fw-bolder btn-primary p-tb-10 m-r-10">{{ __('العودة') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
