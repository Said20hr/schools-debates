                                ...
                                <div class="py-4 px-5" id="pills-tabContent">
                                        <div class="text-right">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-md-6 mb-1">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input id="title" class="form-control"  value="{{ $blog->title }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                                        <label for="description" class="form-label fs-16  pb-2 p-r-10">اسم الكاتب * </label>
                                                        <div class="input-group mb-3">
                                                            <input id="author" class="form-control" value="{{ $blog->author }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                            ...
                                            <div class="d-flex justify-content-start">
                                                ...
                                                <a href="{{ route('news.edit', $blog->id) }}" class="btn col-md-2 btn-lg fs-20 fw-bolder btn-success p-tb-10 m-r-10">تعديل</a>
                                            </div>
                                        </div>
                                </div>
                            </div>
