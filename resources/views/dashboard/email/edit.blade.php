                        ...
                        <div class="col-md-12  no-gutters bor-r5 p-0" style=" box-shadow: 0 5px 10px rgba(0,0,0,0.13), 0 3px 3px rgba(0,0,0,0.17);">
                            <div class=" bg-white" style="border-radius: 0 0 15px 15px">
                                <div class="py-4 px-5" id="pills-tabContent">
                                    <form method="POST" action="{{route('mail.update',$message->id)}}" dir="rtl" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="text-right">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-md-4 mb-1">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input id="name" class="form-control" value="{{ $message->name }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-1">
                                                        <label for="author" class="form-label fs-16  pb-2 p-r-10">الايمايل * </label>
                                                        <div class="input-group mb-3">
                                                            <input id="author" class="form-control" value="{{$message->email }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-1">
                                                        <label for="phone" class="form-label fs-16  pb-2 p-r-10">رقم الهاتف * </label>
                                                        <div class="input-group mb-3">
                                                            <input id="phone" class="form-control" value="{{$message->phone }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                    <div class="row mb-2">
                                                        <div class="col-md-6 mb-1">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input id="subject" class="form-control" value="{{$message->subject }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 mb-1">
                                                            <label for="time" class="form-label fs-16  pb-2 p-r-10">تاريخ * </label>
                                                            <div class="input-group mb-3">
                                                                <input id="time" class="form-control" value="{{$message->created_at->format('Y/m/d H:m') }}" disabled>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="d-flex justify-content-start">
                                                ...
                                                @endif
                                                <a href="{{ route('mail.index') }}" class="btn col-md-2 btn-lg fs-20 fw-bolder btn-primary p-tb-10 m-r-10">{{ __('العودة') }}</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
