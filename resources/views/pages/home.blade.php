        ...
        <section class="container p-tb-25-sm">
                <div class="row text-right">
                    <div class="col-lg-4 col-md-4 col-sm-12 p-tb-14">
                        <div class="trips d-flex justify-content-between align-items-start p-tb-14 p-lr-28">
                            <div class="p-t-14 m-t-20 trips_icons">
                                <img src="{{asset('images/Icons/icon1.svg')}}" alt="icons" class="img-fluid" width="85">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 p-tb-14">
                        <div class="trips d-flex justify-content-between align-items-start p-tb-14 p-lr-28">
                            <div class="p-t-14 m-t-20 trips_icons">
                                <img src="{{asset('images/Icons/icon2.svg')}}" alt="icons" class="img-fluid" width="85">
                            </div>
                            <div class="m-t-14 p-lr-10">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 p-tb-14">
                        <div class="trips d-flex justify-content-between align-items-start p-tb-14 p-lr-28">
                            <div class="p-t-14 m-t-20 trips_icons">
                                <img src="{{asset('images/Icons/icon3.svg')}}" alt="icons" class="img-fluid" width="85">
                            </div>
                            <div class="m-t-14 p-lr-10">
